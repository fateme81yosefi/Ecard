                ...
                >
                  <span className="containtxttitle">
                    <div className="containcircTitle">
                      <div className="circlieLittle" style={{color:moduleDetails.TitleForeColor}}></div>
                      {moduleDetails.Title}
                      <span className="dash"> - </span>
                    </div>
                    <span className="platforntxt">
                      <span className="ssssssss" style={{backgroundColor: moduleDetails.BackgroundColor,color:moduleDetails.SubTitleForeColor}}>
