            ...
            case 2:
              return item.ModuleDetails.map((moduleDetails, index) => {
                switch (moduleDetails.Id) {
                  case 2:
                    return (
                      <div className="platformText" key={index} style={{backgroundColor:moduleDetails.BackgroundColor}}>
            ...
            case 21:
              return item.ModuleDetails.map((moduleDetails, index) => {
                switch (moduleDetails.Id) {
                  case 4:
                    return (
                      <button className="smartPlatform" key={index} style={{backgroundColor:moduleDetails.BackgroundColor}}>
