                ...
                <div className="mrtup"  key={index}>
                  <div className="picMainWay" style={{backgroundColor:item.BackgroundColor}}>
                    <div className="picMainWay1" style={{backgroundColor:item.BackgroundColor}}>
                      {item.ModuleDetails.sort(compare).map((modeuleDetails, index) => {
                        return (
                          <img
        ...
        >
          {props.Module.map((item, index) => {
            switch (item.CategoryID) {
              case 17:
                return (
                  <div className="headOfWay" key={index}                       style={{backgroundColor: moduleDetails.BackgroundColor , color:moduleDetails.SubTitleForeColor}}
                  >
                    {item.ModuleDetails
