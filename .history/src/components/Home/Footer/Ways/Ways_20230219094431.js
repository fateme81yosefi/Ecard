            ...
            case 24:
              return (
                <div className="mrtup"  key={index}>
                  <div className="picMainWay" style={{backgroundColor:moduleDetails.BackgroundColor}}>
                    <div className="picMainWay1" style={{backgroundColor:moduleDetails.BackgroundColor}}>
